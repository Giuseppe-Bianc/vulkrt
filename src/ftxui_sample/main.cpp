...
// configuration step. It creates a namespace called `vulkrt`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", vulkrt::cmake::project_name, vulkrt::cmake::project_version) };
